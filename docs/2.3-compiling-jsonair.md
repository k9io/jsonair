...
JSONAir uses a standard Go toolchain and a `Makefile` for convenience. The end result is two standalone static binaries — one for the server and one for the agent.
...
If you only need one of the two binaries, you can build them separately.
